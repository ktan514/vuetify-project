<template>
    <v-card>
        <quillEditor />
        <v-card-actions>
            <v-btn @click="sendContext" color="primary">投稿</v-btn>
        </v-card-actions>
    </v-card>
</template>
...
// The vue-quill-editor module, highlights the display language of the code blocks.
const cbhlLangList = [
    'c',
    'cpp',
    'css',
...
// The vue-quill-editor module, item list on toolbar.
...
export default {
    name: routerConfig.siteMap.notes.name,
    components: {
